      ...
      messages: [
        ...
        },
        {
          ...
          content: [
            ...
            'Use this safe layout zone for normal text: x 185 to 560, y 72 to 245. Do not put text above y 72.',
            'Use this safe layout zone for QR/barcode: x 470 to 560, y 72 to 235, with width and height between 72 and 92.',
            'Keep the composition clean, premium, and sparse. Avoid visual clutter.',
      ...
      ? input.textElements
          ...
          .map((el) => {
            ...
            return {
              ...
              w,
              h,
              fontSize: this.clamp(el.fontSize, 10, el.type === 'title' ? 28 : 22),
